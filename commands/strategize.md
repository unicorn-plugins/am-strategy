---
description: STEP 3 — AM 전략 수립 (6R 상세·포트폴리오 Phase·TCO/BEP·리스크·거버넌스·가드레일·AI 정책·변화관리·전략 통합)
---
...
3. `${CLAUDE_PLUGIN_ROOT}/skills/strategize/SKILL.md` 파일을 읽고 지시사항을 실행하세요.
