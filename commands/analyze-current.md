---
description: STEP 2 — AM 현황 분석 (인벤토리·건강도·기술부채·A/B/C·6R/TIME·Bounded Context·변화관리 조기 착수)
---
...
3. `${CLAUDE_PLUGIN_ROOT}/skills/analyze-current/SKILL.md` 파일을 읽고 지시사항을 실행하세요.
